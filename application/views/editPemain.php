		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<?php echo form_open_multipart('pemain/edit/'.$this->uri->segment(3)); ?>
								...
								<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="nip" name="posisi" placeholder="Posisi" value="<?php echo $key['posisi'] ?>">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<select name="fk_klub" class="form-control" required>
											<option value=""> ----- </option>
