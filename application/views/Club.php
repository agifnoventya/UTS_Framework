	...
	<body>
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse navbar-ex1-collapse">
									<ul class="nav navbar-nav">
										...
										<li><a href="<?php echo site_url('pemain/All') ?>">Daftar Pemain</a></li>
									</ul>
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1>Daftar Club <a href="<?php echo site_url()?>/Club/addData" class="btn btn-warning"><span class="glyphicon glyphicon-plus"></span> Tambah Club</a> </h1>	
